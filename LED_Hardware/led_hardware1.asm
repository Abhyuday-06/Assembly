...
; there will be one debug option in the same window -> by default software option is selected -> select simulator for software project(don't select anything for hardware)
; on the right side on debug -> in Use -> Keil Monitor 51 Driver
...
; Baud rate=38400
; after saving file -> click only rebuild -> RESET -> Debug -> RESET -> Run
